...
<details>
    <summary>AWS Serverless Lambda Processor</summary>
    
## About The Project
* [Lambda Fixed Resources](/aws-tf-modules/lambda-fixed-resources)
* [Lambda Resources](/aws-tf-modules/lambda-resources)
...
[vpc-screenshot]: images/flow-diagram.png
